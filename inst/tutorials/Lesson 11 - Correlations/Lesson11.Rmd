...
בנוסף לערכים שכל קבוע מקבל (טור Estimate) אנחנו גם מקבלים הערכה של סטיית התקן, ערך הt (שוב המובהקות של המודל מתבססת על מבחן t, הרחבה בנושא זה תהיה בלומדה הבאה) וערך המובהקות (p value). אנחנו מקבלים את הערך המחושב יחד עם סימון מובהקות בצורת כוכביות. כאן קיבלנו א*** שזאת דרגת המובהקות הגבוהה ביותר.  
