...
question("דרג/י את רמת הקושי של החומר המועבר ביחידה לדעתך",
         answer("(1) קל מאוד",  correct=TRUE, message ="תשובתך התקבלה. "),
         answer("(2) קל", message = "תשובתך התקבלה."),
         answer("(3) בינוני", message = "תשובתך התקבלה."),
         answer("(4) מאתגר" ,message = "תשובתך התקבלה."),
         answer("(5) מאתגר מאוד",  message = "תשובתך התקבלה."),
         allow_retry = TRUE
)
```
...
question("עד כמה הלומדה העבירה את החומר בצורה ברורה?",
         answer("(1) ברור מאוד",  correct=TRUE,message ="תשובתך התקבלה. "),
         answer("(2) ברור",  message = "תשובתך התקבלה."),
         answer("(3) בינוני", message = "תשובתך התקבלה."),
         answer("(4) לא ברור",  message = "תשובתך התקבלה."),
         answer("(5) לא הבנתי כלום",  message = "תשובתך התקבלה."),
         allow_retry = TRUE
)
```
...
question("איזה נושא בלומדה היה הכי קשה לדעתך?",
         answer("המבוא", correct=TRUE, message ="תשובתך התקבלה. "),
         answer("בוטסטראפ",  message = "תשובתך התקבלה."),
         answer("כל מבחני הפרמוטציות", message = "תשובתך התקבלה."),
         answer("מבחן פרמוטציות לשני מדגמים",  message = "תשובתך התקבלה."),
         answer("מבחן פרמוטציות למדגמים תלויים",  message = "תשובתך התקבלה."),
         answer(" מבחן פרמוטציות עם ערך ייחוס", message = "תשובתך התקבלה."),
         answer("מבחן פרמוטציות לקשר לינארי", message = "תשובתך התקבלה."),
         allow_retry = TRUE
)
```
