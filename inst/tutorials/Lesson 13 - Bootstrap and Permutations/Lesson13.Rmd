...
עם שינוי מאוד קטן בקוד יכולנו להשתמש באותה לולאה כדי לדמות את התפלגות האפס של שני מבחנים שונים! כלומר ברגע שהבנו את העיקרון, נפתחו בפנינו מגוון של אפשרויות. 
...
כלומר, אפשר לנסח את ההשערה גם כך - השערת האפס היא שתוחלת ההפרשים היא אפס. לכן אם נסתכל על הוקטור של ההפרשים הם אמורים להתפזר אקראית סביב אפס והסימן (האם הערכים הם חיוביים או שליליים) של ההפרשים הוא אקראי.  
...
ההתאמה היחידה שנצטרך לבצע היא בעצם למצוא את הדרך להפוך את ערך הייחוס ל0 שכן שינוי הסימן בצורה אקראית מבוסס על זה ערך ייחוס של 0. נוכל לעשות זאת על ידי החסרה של ערך הייחוס מהנתונים עצמם. כלומר על השוואת ההפרש בין כל ערך במדגם לערך היחוס, תחת השערת האפס שאין הבדל.
...
`שאלה 3`   
ועכשיו לאירוע המרכזי. השתמשו בקוד שכתבתם בשיעור הקודם (מבחן t) סננו תשובות שגויות ותשובות שזמן התגובה שלהן מעל 1500 מילי שניות.  
בצעו את המבחן המשווה את זמן התגובה בתנאי התואם ללא תואם, שוב, הפעם באמצעות מבחן פרמוטציות לדגימות תלויות על אפקט הסטרופ.  
