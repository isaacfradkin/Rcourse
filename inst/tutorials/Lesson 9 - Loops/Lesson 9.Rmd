...
`תרגיל`
השלימו את הקוד בלולאה הבאה כך שידווח על הציונים של כל משתתף. שימו לב, 
...
### דוגמא נוספת
 ...
 בדרך כלל נרצה שהלולאות יעשו יותר מאשר רק לשלוף ולהדפיס ערכים. התבוננו בדוגמאות הבאות ונסו להבין את מטרתן:
...
לעיתים קרובות נרצה לשמור את תוצרי הלולאה באובייקט חדש. נוכל לעשות זאת באמצעות הגדרת אובייקט חדש והשמה של הערך של האיבר בתוך הלולאה לאובייקט זה.
