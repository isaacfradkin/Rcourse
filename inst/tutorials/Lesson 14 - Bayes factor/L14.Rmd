...
לשם כך תצטרכו לעדכן את האמונה המקדימה שלנו (50% לכל השערה) על סמך תוצאות המדגם הראשון, לשנות את האמונה המקדימה בהתאם לתוצאות ולעדכן אותה שוב על סמך התוצאות מהמדגם השני.
